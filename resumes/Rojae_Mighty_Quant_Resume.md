...
- Built a Python ML pipeline with pandas, NumPy, and scikit-learn to forecast short-horizon price movement from limit-order-book data.
- Engineered order-flow imbalance, bid-ask spread, and price-change features for market microstructure modeling.
- Evaluated models with walk-forward validation and transaction-cost-aware backtesting to reduce lookahead bias.
...
**Data and ML:** pandas, NumPy, scikit-learn, feature engineering, statistical analysis, walk-forward validation, dynamic programming  
**Research Tools:** ROOT, Monte Carlo event generators, numerical simulation, Git, GitHub, Linux/Unix environments  
**Domains:** Market microstructure, Electron-Ion Collider physics, particle-collision data, gluon saturation, geometric scaling
